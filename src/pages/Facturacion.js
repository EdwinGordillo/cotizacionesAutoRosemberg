...
function Facturacion() {
    const [useCurrentDate, setUseCurrentDate] = useState(true); // Por defecto usar la fecha actual
    const [customDate, setCustomDate] = useState(""); // Para la fecha personalizada
    ...
    const handleGenerateInvoice = async (e) => {
        ...
        const fechaFactura = useCurrentDate
            ? new Date().toLocaleDateString("es-CO")
            : new Date(customDate).toLocaleDateString("es-CO");
        ...
        const factura = {
            ...
            valorTotal,
            fecha: fechaFactura, // Usamos la fecha seleccionada
            facturacion: `FAC-${facturacion}`
        };
        ...
        setDescriptions([]);
        setUseCurrentDate(true); // Volver a usar la fecha actual
        setCustomDate(""); // Limpiar el campo de fecha personalizada
    };
            ...
            <Grid container spacing={2}>
                <Grid item xs={12}>
                    <Button
                        ...
                        variant="outlined"
                        color="primary"
                        onClick={() => setUseCurrentDate(!useCurrentDate)} // Cambiar entre usar la fecha actual o personalizada
                    >
                        {useCurrentDate ? "Usar Fecha Personalizada" : "Usar Fecha Actual"}
                    </Button>
                </Grid>
            {!useCurrentDate && (
                <Grid item xs={12}>
